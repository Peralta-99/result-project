...
trait Friendable {
    public function add_friend($user_requested_id) {
        ...
        if ($this->has_pending_friend_request_sent_to($user_requested_id) === 1) return 'already sent a friend request';
        if ($this->has_pending_friend_request_from($user_requested_id) === 1) return $this->accept_friend($user_requested_id);
